...
typedef Opt = {
  ...
  public var eadirection:String;
  public var edcompatible:Bool;
  ...
  public var expandtab:Bool;
  public var exrc:Bool;
  ...
  // 	is read.
  public var fileencodings:String;
  ...
  public var fileignorecase:Bool;
  ...
  public var foldminlines:Int;
  // `'foldnestmax'`  `'fdn'` 	number (default: 20)
  // 			local to window
  // 	Sets the maximum nesting of folds for the "indent" and "syntax"
  // 	methods.  This avoids that too many folds will be created.  Using more
  // 	than 20 doesn't work, because the internal limit is 20.
  public var foldnestmax:Int;
  ...
  public var formatlistpat:String;
  ...
  public var gdefault:Bool;
  // `'grepformat'`  `'gfm'` 	string	(default "%f:%l:%m,%f:%l%m,%f  %l%m")
  // 			global
  // 	Format to recognize for the ":grep" command output.
  // 	This is a scanf-like string that uses the same format as the
  // 	`'errorformat'`  option: see |errorformat|.
  public var grepformat:String;
  ...
  // <
  public var guitabtooltip:String;
  ...
  // 	although the `'hidden'`  option is off when these three are public var : Boolean;:
  ...
  // 	If the character is `'@'` , all characters where isalpha() returns public var : Boolean;
  ...
  public var isprint:String;
  // `'joinspaces'`  `'js'` 	boolean	(default off)
  // 			global
  // 	Insert two spaces after a `'.'` , `'?'`  and `'!'`  with a join command.
  // 	Otherwise only one space is inserted.
  public var joinspaces:Bool;
  ...
  public var langmenu:String;
  public var langnoremap:Bool;
  // `'langremap'`  `'lrm'` 	boolean (default off)
  // 			global
  // 	When off, setting `'langmap'`  does not apply to characters resulting from
  // 	a mapping.  If setting `'langmap'`  disables some of your mappings, make
  // 	sure this option is off.
  public var langremap:Bool;
  ...
  public var lisp:Bool;
  // `'lispwords'`  `'lw'` 	string	(default is very long)
  // 			global or local to buffer |global-local|
  // 	Comma-separated list of words that influence the Lisp indenting when
  // 	enabled with the |`'lisp'` | option.
  public var lispwords:String;
  ...
  // <
  public var makeencoding:String;
  ...
  public var matchpairs:String;
  // `'matchtime'`  `'mat'` 	number	(default 5)
  // 			global
  // 	Tenths of a second to show the matching paren, when `'showmatch'`  is
  // 	set.  Note that this is not in milliseconds, like other options that
  // 	set a time.  This is to be compatible with Nvi.
  public var matchtime:Int;
  public var maxcombine:Int;
  ...
  public var maxmempattern:Int;
  // `'menuitems'`  `'mis'` 	number	(default 25)
  // 			global
  // 	Maximum number of items to use in a menu.  Used for menus that are
  // 	generated from a list of items, e.g., the Buffers menu.  Changing this
  // 	option has no direct effect, the menu must be refreshed first.
  public var menuitems:Int;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var modelineexpr:Bool;
  // `'modelines'`  `'mls'` 	number	(default 5)
  // 			global
  // 	If `'modeline'`  is on `'modelines'`  gives the number of lines that is
  // 	checked for set commands.  If `'modeline'`  is off or `'modelines'`  is zero
  // 	no lines are checked.  See |modeline|.
  public var modelines:Int;
  ...
  public var mousefocus:Bool;
  // `'mousehide'`  `'mh'` 	boolean	(default on)
  // 			global
  // 			{only works in the GUI}
  // 	When on, the mouse pointer is hidden when characters are typed.
  // 	The mouse pointer is restored when the mouse is moved.
  public var mousehide:Bool;
  ...
  public var mouseshape:String;
  // `'mousetime'`  `'mouset'` 	number	(default 500)
  // 			global
  // 	Defines the maximum time in msec between two mouse clicks for the
  // 	second click to be recognized as a multi click.
  public var mousetime:Int;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var operatorfunc:String;
  ...
  // 	being set.  The same is public var : Boolean; for a terminal where Vim handles the
  // 	mouse clicks itself.
  ...
  public var pastetoggle:String;
  // `'patchexpr'`  `'pex'` 	string	(default "")
  // 			global
  // 	Expression which is evaluated to apply a patch to a file and generate
  // 	the resulting new version of the file.  See |diff-patchexpr|.
  public var patchexpr:String;
  ...
  public var preserveindent:Bool;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var printdevice:String;
  // `'printencoding'`  `'penc'` 	string	(default empty, except for some systems)
  // 			global
  // 	Sets the character encoding used when printing.
  // 	See |penc-option|.
  public var printencoding:String;
  ...
  // 	See |pheader-option|.
  public var printheader:String;
  // `'printmbcharset'`  `'pmbcs'`   string (default "")
  // 			global
  // 	The CJK character set to be used for CJK output from |:hardcopy|.
  // 	See |pmbcs-option|.
  public var printmbcharset:String;
  // `'printmbfont'`  `'pmbfn'` 	string (default "")
  // 			global
  // 	List of font names to be used for CJK output from |:hardcopy|.
  // 	See |pmbfn-option|.
  public var printmbfont:String;
  // `'printoptions'`  `'popt'`  string (default "")
  // 			global
  // 	List of items that control the format of the output of |:hardcopy|.
  // 	See |popt-option|.
  public var printoptions:String;
  ...
  public var pumblend:Int;
  // `'pumheight'`  `'ph'` 	number	(default 0)
  // 			global
  // 	Maximum number of items to show in the popup menu
  // 	(|ins-completion-menu|). Zero means "use available screen space".
  public var pumheight:Int;
  // `'pumwidth'`  `'pw'` 		number	(default 15)
  // 			global
  // 	Minimum width for the popup menu (|ins-completion-menu|).  If the
  // 	cursor column + `'pumwidth'`  exceeds screen width, the popup menu is
  // 	nudged to fit on the screen.
  public var pumwidth:Int;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var quickfixtextfunc:String;
  ...
  // 	options.
  public var relativenumber:Bool;
  public var remap:Bool;
  ...
  public var rightleftcmd:String;
  ...
  // 	the session.
  public var sessionoptions:String;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var shellcmdflag:String;
  ...
  public var breakat:String;
  // `'breakindent'`  `'bri'` 	boolean (default off)
  // 			local to window
  // 	Every wrapped line will continue visually indented (same amount of
  // 	space as the beginning of that line), thus preserving horizontal blocks
  // 	of text.
  public var breakindent:Bool;
  ...
  public var breakindentopt:String;
  ...
  // 	See |C-indenting|.
  public var cinkeys:String;
  // `'cinoptions'`  `'cino'` 	string	(default "")
  // 			local to buffer
  // 	The `'cinoptions'`  affect the way `'cindent'`  reindents lines in a C
  // 	program.  See |cinoptions-values| for the values of this option, and
  // 	|C-indenting| for info on C indenting in general.
  public var cinoptions:String;
  ...
  //
  // <
  public var cinscopedecls:String;
  ...
  public var cmdheight:Int;
  // `'cmdwinheight'`  `'cwh'` 	number	(default 7)
  // 			global
  // 	Number of screen lines to use for the command-line window. |cmdwin|
  public var cmdwinheight:Int;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var completefunc:String;
  ...
  public var completeslash:String;
  ...
  public var concealcursor:String;
  ...
  public var cpoptions:String;
  // `'cscopepathcomp'`  `'cspc'` 	number	(default 0)
  // 			global
  // 	Determines how many components of the path to show in a list of tags.
  // 	See |cscopepathcomp|.
  public var cscopepathcomp:Int;
  // `'cscopeprg'`  `'csprg'` 	string	(default "cscope")
  // 			global
  // 	Specifies the command to execute cscope.  See |cscopeprg|.
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var cscopeprg:String;
  // `'cscopequickfix'`  `'csqf'`  string	(default "")
  // 			global
  // 	Specifies whether to use quickfix window to show cscope results.
  // 	See |cscopequickfix|.
  public var cscopequickfix:String;
  // `'cscoperelative'`  `'csre'`  boolean (default off)
  // 			global
  // 	In the absence of a prefix (-P) for cscope. setting this option enables
  // 	to use the basename of cscope.out path as the prefix.
  // 	See |cscoperelative|.
  public var cscoperelative:Bool;
  // `'cscopetag'`  `'cst'` 	boolean (default off)
  // 			global
  // 	Use cscope for tag commands.  See |cscope-options|.
  public var cscopetag:Bool;
  // `'cscopetagorder'`  `'csto'` 	number	(default 0)
  // 			global
  // 	Determines the order in which ":cstag" performs a search.  See
  // 	|cscopetagorder|.
  public var cscopetagorder:Int;
  public var cscopeverbose:Bool;
  ...
  public var cursorlineopt:String;
  ...
  public var shelltemp:Bool;
  // `'shellxescape'`  `'sxe'` 	string	(default: "")
  // 			global
  // 	When `'shellxquote'`  is set to "(" then the characters listed in this
  // 	option will be escaped with a `'^'`  character.  This makes it possible
  // 	to execute most external commands with cmd.exe.
  public var shellxescape:String;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var shellxquote:String;
  // `'shiftround'`  `'sr'` 	boolean	(default off)
  // 			global
  // 	Round indent to multiple of `'shiftwidth'` .  Applies to > and <
  // 	commands.  CTRL-T and CTRL-D in Insert mode always round the indent to
  // 	a multiple of `'shiftwidth'`  (this is Vi compatible).
  public var shiftround:Bool;
  ...
  public var showmatch:Bool;
  // `'showmode'`  `'smd'` 	boolean	(default: on)
  // 			global
  // 	If in Insert, Replace or Visual mode put a message on the last line.
  // 	The |hl-ModeMsg| highlight group determines the highlighting.
  // 	The option has no effect when `'cmdheight'`  is zero.
  public var showmode:Bool;
  ...
  // 	|set-spc-auto|.
  public var spellcapcheck:String;
  ...
  // 			this case.
  public var spelloptions:String;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var spellsuggest:String;
  // `'splitbelow'`  `'sb'` 	boolean	(default off)
  // 			global
  // 	When on, splitting a window will put the new window below the current
  // 	one. |:split|
  public var splitbelow:Bool;
  // `'splitright'`  `'spr'` 	boolean	(default off)
  // 			global
  // 	When on, splitting a window will put the new window right of the
  // 	current one. |:vsplit|
  public var splitright:Bool;
  ...
  public var termbidi:Bool;
  public var termencoding:String;
  // `'termguicolors'`  `'tgc'` 	boolean (default off)
  // 			global
  // 	Enables 24-bit RGB color in the |TUI|.  Uses "gui" |:highlight|
  // 	attributes instead of "cterm" attributes. |guifg|
  // 	Requires an ISO-8613-3 compatible terminal.
  public var termguicolors:Bool;
  ...
  public var termpastefilter:String;
  ...
  // 	This option cannot be set from a |modeline| or in the |sandbox|, for
  // 	security reasons.
  public var thesaurusfunc:String;
  // `'tildeop'`  `'top'` 		boolean	(default off)
  // 			global
  // 	When on: The tilde command "~" behaves like an operator.
  public var tildeop:Bool;
  ...
  public var ttimeout:Bool;
  // `'ttimeoutlen'`  `'ttm'` 	number	(default 50)
  // 			global
  // 	Time in milliseconds to wait for a key code sequence to complete. Also
  // 	used for CTRL-\ CTRL-N and CTRL-\ CTRL-G when part of a command has
  // 	been typed.
  public var ttimeoutlen:Int;
  public var ttyfast:Bool;
  ...
  public var varsofttabstop:String;
  ...
  public var viminfo:String;
  public var viminfofile:String;
  ...
  public var wildignorecase:Bool;
  ...
  public var winfixheight:Bool;
  // `'winfixwidth'`  `'wfw'` 	boolean	(default off)
  // 			local to window
  // 	Keep the window width when windows are opened or closed and
  // 	`'equalalways'`  is set.  Also for |CTRL-W_=|.
  // 	The width may be changed anyway when running out of room.
  public var winfixwidth:Bool;
  ...
  // <
  public var winhighlight:String;
  ...
  public var writebackup:Bool;
  public var writedelay:Int;
}
